...
BACKGROUND = path.join(directory, "resources/background2.png")
...
FONT_URL = path.join(directory, "resources/American Captain.ttf")
SPRITE_SIZE = 40
NB_SPRITE = 15
WINDOW_SIZE = SPRITE_SIZE * NB_SPRITE
WINDOW_HEIGHT = (SPRITE_SIZE * NB_SPRITE) + (SPRITE_SIZE * 2)
